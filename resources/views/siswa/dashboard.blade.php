    ...
    <div class="bg-white rounded-2xl shadow-md border border-theme-green/10 p-6 mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-100 text-green-800 font-bold text-sm">
                <span class="material-symbols-outlined icon-filled text-green-600" style="font-size:18px">celebration</span>DITERIMA
            </span>
            @elseif($applicant->status==='rejected')
            <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-100 text-red-800 font-bold text-sm">
                <span class="w-2 h-2 bg-red-500 rounded-full"></span>Tidak Diterima
            </span>
            @endif
        </div>
